...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"public/admin/templates/dashboard.html"}).state("tables",{url:"/tables",templateUrl:"public/admin/tables.html"})}]);
