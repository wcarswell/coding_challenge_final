...
"use strict";function CountryCtrl(t,n,o,e,a){t.config={"new":"Add Country",modify:"Modify Country",modalSize:"sm",templateUrl:"country.html",controller:"ModalCountryCtrl",endPoint:"/admin/country/"},t.selected="",t.$state=n,t.reloadCountryList=function(){o.get(t.config.endPoint).success(function(n,o,e,a){t.countries=n})},t.modify=function(n){t.openModal(n,t.config.modify)},t["new"]=function(){t.openModal("",t.config["new"])},t["delete"]=function(n){var e=t.config.endPoint;e+=n.country_id+"/",o({url:e,method:"DELETE",data:{}}).then(function(n){"fail"!=n.data.status?t.reloadCountryList():alert(n.data.message)},function(t){alert("Failed to delete country: "+n.name)})},t.openModal=function(n,o){var r=e.open({animation:t.animationsEnabled,templateUrl:t.config.templateUrl,controller:t.config.controller,size:t.config.modalSize,resolve:{country:function(){return n},action:function(){return o},config:function(){return t.config}}});r.result.then(function(n){t.reloadCountryList()},function(){a.info("Modal dismissed at: "+new Date)})},t.reloadCountryList()}function ModalCountryCtrl(t,n,o,e,a,r){t.action=a,t.selected=e,t.ok=function(){var a=r.endPoint;e.hasOwnProperty("country_id")&&(a+=e.country_id+"/"),o({url:a,method:"POST",data:{country:t.selected}}).then(function(t){"fail"!=t.data.status?n.close():alert(t.data.message)},function(t){alert("Failed to insert/update country")})},t.cancel=function(){n.dismiss("cancel")}}angular.module("RDash").controller("CountryCtrl",["$scope","$state","$http","$modal","$log",CountryCtrl]),angular.module("RDash").controller("ModalCountryCtrl",["$scope","$modalInstance","$http","country","action","config",ModalCountryCtrl]);
...
function MasterCtrl(t,e,o,r){t.$state=o;var a=992;t.getWidth=function(){return window.innerWidth},t.selected="",t.$watch(t.getWidth,function(o,r){o>=a?angular.isDefined(e.get("toggle"))?t.toggle=e.get("toggle")?!0:!1:t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}function LowStockService(t){var e={};return e.message="",e.prepForBroadcast=function(t){this.message=t,this.broadcastItem()},e.reloadLowStockAlert=function(){t.$broadcast("reloadLowStockAlert")},e}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","$state","$http",MasterCtrl]),angular.module("RDash").factory("LowStockService",["$rootScope",LowStockService]);
